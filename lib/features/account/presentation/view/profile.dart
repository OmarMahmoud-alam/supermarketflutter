                      ...
                      TextFormField(
                        decoration: InputDecoration(
                          ...
                          focusedBorder: OutlineInputBorder(
                            borderSide:
                                const BorderSide(color: TColor.primary, width: 1.0),
                            borderRadius: BorderRadius.circular(5.0),
                          ),
                          hintText: 'Dominic',
                          enabledBorder: OutlineInputBorder(
                            borderSide:
                                const BorderSide(color: TColor.offwhite, width: 1.0),
                        ...
                        decoration: InputDecoration(
                          ...
                          focusedBorder: OutlineInputBorder(
                            borderSide: const BorderSide(
                                color: TColor.primaryText, width: 1.0),
                            borderRadius: BorderRadius.circular(5.0),
                          ),
                          hintText: '•••••••••••••••••',
                          enabledBorder: OutlineInputBorder(
