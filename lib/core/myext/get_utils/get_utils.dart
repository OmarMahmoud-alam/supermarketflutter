...
class GetUtils {
  ...
  static void printFunction(
    ...
    Customlog.log('$prefix $value $info'.trim());
  }
}
...
class Customlog {
  ...
  static void log(String message,
    ...
    final logMessage = '$emoji   $nameStr $message $errorStr $stackTraceStr';
    log(logMessage,
        name: name, time: time, sequenceNumber: sequenceNumber, level: level);
  }
